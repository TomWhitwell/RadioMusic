...
#define divisors 13
int divisor[divisors] = {1,2,4,8,16,32,64,128,256,3,6,9,12};
time = map(time, 0,1024,0,divisors);
unsigned long looplength = playRaw1.lengthMillis();
pTime = looplength / divisor[time];
